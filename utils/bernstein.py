...
def bernstein_coeff_order10_new(n, tmin, tmax, t_actual, device=th.device("cuda")):
    ...
    P = (th.hstack([P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10])).to(device=device)
    Pdot = (th.hstack([P0dot, P1dot, P2dot, P3dot, P4dot, P5dot, P6dot, P7dot, P8dot, P9dot, P10dot])/l).to(device=device)
    Pddot = (th.hstack([P0ddot, P1ddot, P2ddot, P3ddot, P4ddot, P5ddot, P6ddot, P7ddot, P8ddot, P9ddot, P10ddot])/(l**2)).to(device=device)
