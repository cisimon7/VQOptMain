...
#         t_fin = 15.0
#         num_up = 1500
#         self.Ts = t_fin / num_up
#         tot_time_up = np.linspace(0, t_fin, num_up).reshape(num_up, 1)
...
#         self.num_up_steps = 4
#         self.cnt = 0
#         self.a_controls = np.zeros(shape=self.num_up_steps)
#         self.steer_controls = np.zeros(shape=self.num_up_steps)
#
#
